...
\begin{multicols}{2}
\boiteQFQ{Question 1 :}{
Classer par ordre croissant ces trois nombres.\begin{center}
$A = \dfrac{3}{10}$ \,\,\,\, $B = \dfrac{1}{4}$ \,\,\,\, $C = 0,31$
\end{center}
\begin{center}\textbf{A}. $A < B < C$\qquad \textbf{B}. $B < A < C$\\ \textbf{C}. $B < C < A$\qquad \textbf{D}. $A < C < B$
\end{center}
}
\boiteQFQ{Question 2 :}{
Choisir deux nombres puis calculer l'inverse de la somme de $7$ et de $-8$.
\begin{center}
$\square\;$ $\dfrac{1}{56}$\qquad $\square\;$ $1$\qquad $\square\;$ $-1$\qquad
\end{center}
}
\end{multicols}
\vspace{-0.85cm}
...
\boiteQFQ{Question 3 :}{
Choisir l'expression \acc{factorisée} de  $3x^2-14x+8$
\begin{center}
\textbf{A}. $\left( x+4\right)\left( 3x+2\right)$\qquad \textbf{B}. $\left( x-4\right)\left( 3x-2\right)$\\\phantom{a}\qquad \textbf{C}. $\left( x+4\right)\left( 3x-2\right)$
\end{center}
}
\boiteQzeroFA{}
\end{multicols}
...
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] B
\end{itemize}
}
\end{multicols}
\newpage
...
\begin{itemize}[itemsep=0.2em]
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] B
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{2.} \end{itembox}}] $-1$
\end{itemize}
}
\end{multicols}
\newpage
...
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] B
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{2.} \end{itembox}}] $-1$
\item[\raisebox{-0.1cm}{\begin{itembox} \textbf{3.} \end{itembox}}] B
\end{itemize}
}
\end{multicols}
...
Pour comparer ces trois nombres, on les écrit sous forme décimale :\\$A = \dfrac{3}{10} = 0,3$ \qquad
$B = \dfrac{1}{4} = 0,25$
...
\medskip
On a donc : $0,25 < 0,3 < 0,31$.\\Finalement : ${\color[HTML]{f15929}\boldsymbol{B < A < C}}$.\\La bonne réponse est la réponse {\bfseries \color[HTML]{f15929}B}.
...
La somme de $7$ et $-8$ est $-1$. \\
Son inverse est : $\dfrac{1}{7+(-8)}=\dfrac{1}{-1}=-1$.
...
$\begin{aligned}
\left (x-4\right)\left(3x-2\right)&=3x^2-2x-12x+8\\
&=3x^2-14x+8\\
