...
%themes abordés : Équations, ,
\pagecolor{customBackground}
\vspace{-0.5cm}
\begin{multicols}{2}
\boiteQFQ{Question 1 :}{
\textbf{Résoudre} l'équation suivante :
\begin{center}$7x + 23 = -4x + 68$\end{center}
}
\boiteQFQ{Question 2 :}{
...
\boiteQFA{
    ...
    \begin{itemize}[itemsep=0.2em]
        \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] $x = \dfrac{45}{11}$
    \end{itemize}
}
\end{multicols}
\newpage
...
\begin{multicols}{2}
    ...
    \boiteQFA{
        ...
        \begin{itemize}[itemsep=0.2em]
            \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] $x = \dfrac{45}{11}$
            \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{2.} \end{itembox}}]
        \end{itemize}
    }
\end{multicols}
\newpage
...
\begin{multicols}{2}
    ...
    \begin{multicols}{2}
        ...
        \boiteQFA{
            ...
            \begin{itemize}[itemsep=0.2em]
                \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] $x = \dfrac{45}{11}$
                \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{2.} \end{itembox}}]
                \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{3.} \end{itembox}}]
            \end{itemize}
        }
    \end{multicols}
    ...
    \boiteQFdet{Solution détaillée de la question 1 :}{
        ...
        \begin{center}$7x + 23 = -4x + 68$\end{center}
            ...
            Pour \textbf{résoudre} cette équation, on utilise la \textbf{méthode de transposition} : on regroupe les termes en $x$ d'un côté et les constantes de l'autre.
            
            $7x + 23 = -4x + 68$
            
            On \textbf{ajoute} $4x$ aux deux membres :
            
            $7x + 4x + 23 = 68$
            
            On \textbf{soustrait} $23$ aux deux membres :
            
            $11x = 68 - 23$
            
            $11x = 45$
            
            On \textbf{divise} par $11$ :
            
            $x = \dfrac{45}{11}$
            
            La \textbf{solution} de l'équation est : $\mathbf{\color{red} x = \dfrac{45}{11}}$
