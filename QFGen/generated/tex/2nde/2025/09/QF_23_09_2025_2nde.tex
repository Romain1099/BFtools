...
\begin{center}$\fpeval{\numa*\numb}=\Decomposition[Exposant]{\fpeval{\numa*\numb}}=\left(2^2\right)^2 \times3^2\times2 = (4\times3)^2\times 2$\end{center}
