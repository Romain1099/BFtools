...
%themes abordés : Arithmétique, Divisions de fractions (1), Pourcentages
...
\xdef\nombre{\fpeval{\numa*\numb^\puisb*\numc^\puisc}}
Donner la \acc{décomposition} en produit de facteurs premiers du nombre $\num{\nombre}$.
}
\boiteQFQ{Question 2 :}{
%version 7 - Court
...
\boiteQFA{
    ...
    \begin{itemize}[itemsep=0.2em]
        \item[\raisebox{-0.1cm}{\begin{itembox} \textbf{1.} \end{itembox}}] \def\numa{5}\def\numb{7}\def\numc{2}\def\puisb{1}\def\puisc{3}\xdef\nombre{\fpeval{\numa*\numb^\puisb*\numc^\puisc}}\Decomposition[Exposant]{\nombre}
    \end{itemize}
}
\end{multicols}
\newpage
...
\begin{multicols}{2}
    ...
    \boiteQFdet{Solution détaillée de la question 1 :}{
        ...
        \xdef\nombre{\fpeval{\numa*\numb^\puisb*\numc^\puisc}}
        Par division succesives par des nombres premiers :
        ...
        \[\num{2450}=\Decomposition[Exposant]{\nombre}\]
